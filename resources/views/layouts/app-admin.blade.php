...
<span class="text-sm text-gray-500 sm:text-center">© 2023 <a href="https://laravel.com" class="hover:underline">Tech Blog </a>v{{ Illuminate\Foundation\Application::VERSION }} (PHP v{{ PHP_VERSION }}) . All Rights Reserved.
</span>
